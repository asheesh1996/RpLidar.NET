...
namespace RpLidar.NET
{
    ...
    public class RpLidarSerialDevice : ILidarService
    {
        ...
        private LidarConfResponse GetLidarConf(LidarConfSubType subType, uint argument = 0)
            => throw new NotSupportedException("GetLidarConf is not yet implemented on this device.");
    }
}